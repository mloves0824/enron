...
var CmdNew = &cobra.Command{
	...
	Long:  "Create a service project using the repository template. Example: enron new helloworld",
	Run:   run,
}
...
func init() {
	if repoURL = os.Getenv("ENRON_LAYOUT_REPO"); repoURL == "" {
		repoURL = "https://github.com/mloves0824/enron-layout.git"
	}
	timeout = "60s"
