...
// EnronMod returns enron mod.
func EnronMod() string {
	...
	if path, err := ModuleVersion("github.com/mloves0824/enron"); err == nil {
		return filepath.Join(cachePath, path)
	}
	return filepath.Join(gopath, "src", "github.com", "mloves0824", "enron")
}
