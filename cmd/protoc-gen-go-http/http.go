...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/mloves0824/enron/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/mloves0824/enron/transport/http/binding")
)

var methodSets = make(map[string]int)

// generateFile generates a _http.pb.go file containing enron errors definitions.
...
// generateFileContent generates the enron errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool, omitemptyPrefix string) {
	...
	g.P("// is compatible with the enron package it is being compiled against.")
