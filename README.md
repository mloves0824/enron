...
<a href="https://pkg.go.dev/github.com/mloves0824/enron"><img src="https://pkg.go.dev/badge/github.com/mloves0824/enron" alt="GoDoc"></a>
...
go install github.com/mloves0824/enron/cmd/enron@latest && enron upgrade
```
  
```shell
enron new helloworld
