...
import (
	...
	"github.com/mloves0824/enron/registry"
)

// Defines the key name of specific fields
// Enron needs to cooperate with the following fields to run properly on Kubernetes:
// enron-service-id: define the ID of the service
// enron-service-app: define the name of the service
// enron-service-version: define the version of the service
// enron-service-metadata: define the metadata of the service
// enron-service-protocols: define the protocols of the service
//
// Example Deployment:
/*
apiVersion: apps/v1
...
template:
  metadata:
    labels:
      app: nginx
      enron-service-id: "56991810-c77f-4a95-8190-393efa9c1a61"
      enron-service-app: "nginx"
      enron-service-version: "v3.5.0"
    annotations:
      enron-service-protocols: |
        {"80": "http"}
      enron-service-metadata: |
...
const (
	...
	LabelsKeyServiceID = "enron-service-id"
	// LabelsKeyServiceName is used to define the name of the service
	LabelsKeyServiceName = "enron-service-app"
	// LabelsKeyServiceVersion is used to define the version of the service
	LabelsKeyServiceVersion = "enron-service-version"
	// AnnotationsKeyMetadata is used to define the metadata of the service
	AnnotationsKeyMetadata = "enron-service-metadata"
	// AnnotationsKeyProtocolMap is used to define the protocols of the service
	// Through the value of this field, Enron can obtain the application layer protocol corresponding to the port
	// Example value: {"80": "http", "8081": "grpc"}
	AnnotationsKeyProtocolMap = "enron-service-protocols"
)
